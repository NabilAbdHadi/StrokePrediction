...
async function predictStroke(userInput) {
    ...
    return model.predict(tf.cast(input, 'int32').transpose);
};
...
function RadioQuestion({ id, question, answers }) {
    ...
    return ( <FormControl className={classes.question}>
        <FormLabel> { question } </FormLabel> 
        <br />

        <RadioGroup className={classes.answer}
        m = { 2 }
        row name = {id}
        value = { value }
        onChange = { handleChange }> {
            answers.map(element => <FormControlLabel name = {id}
                value = { element }
                control = { <Radio /> }
                label = { element }
                />)
    ...
    function SliderQuestion({ id, question, range }) {
        ...
        return ( <FormControl>
            ...
            <br />
            <br />
            <Slider className = { classes.answer }
            defaultValue = { value }
    ...
    class App extends Component {
        ...
        render() {
            const handleSubmit = (event) => {
                ...
                const userData = Array(Object.values(userAnswer));
                console.log(userData[0]);
                console.log(predictStroke(userData[0]));
            };
            return (

                <Grid className={myStyle.backgroundLayout}
                ...
                style = {
                  ...
                  <Container className = "content">
                    ...
                    This system is predict whether you have stroke or not according to your answer. </Typography> 
                    <br/>
                    <br/>
                    </Grid> 
